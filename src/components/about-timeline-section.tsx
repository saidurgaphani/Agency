...
const milestones = [
  {
    year: "2019",
    title: "triser. launch",
    description: "In December 2020, Alex Carter, Jamie Lin, and Mia Chen joined forces to establish triser. with a clear mission: to make cutting-edge design accessible and affordable for all tech innovators. The studio specializes in AI, SaaS, and tech solutions, addressing complex challenges with creative design.",
    isFirst: true,
  },
  {
    year: "2015",
    title: "triser. debut",
    description: "Building on the success of triser. debut, the studio expanded in 2021, focusing on enhancing user experiences in tech, offering services like UX/UI design, branding, and product development.",
    isFirst: false,
  },
  {
    year: "3",
    title: "Global expansion",
    description: "triser. broadened its reach to international markets, launching services in Europe and Asia. The studio also opened a new design hub in Berlin, making its innovative solutions available to a wider audience.",
    isFirst: false,
  },
  {
    year: "4",
    title: "triser. goes public",
    description: "triser. went public through a SPAC on NASDAQ: TRSR. The studio acquired the design firm PixelCraft and the tech platform InnovateX, significantly enhancing its global presence.",
    isFirst: false,
  },
];
