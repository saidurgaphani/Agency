    ...
    return (
        ...
        >
            ...
            <text
                ...
                strokeWidth="0.3"
                className="font-brand text-5xl stroke-neutral-900 dark:stroke-neutral-200"
                fill="transparent"
            ...
            <motion.text
                ...
                alignmentBaseline="middle"
                strokeWidth="0.3"
                className="font-brand text-5xl stroke-neutral-700/30 dark:stroke-neutral-200/30"
                fill="transparent"
